# Data preprocessing --> refers to the complete set of text-cleaning operations applied to the review column of the dataset before it is used for model training. The goal is to transform raw text into a standardized, noise-free, and meaningful form that improves model performance. 🗑 
